...
defined('API_EMAIL')        OR define('API_EMAIL', "cnoih@yahoo.com"); // airvend api url
defined('API_PASSWORD')        OR define('API_PASSWORD', 6424); // airvend api url

// user types
defined('COMPANY')        OR define('COMPANY', 700); // company accunt
defined('3RDPARTY')        OR define('3RD PARTY', 730); // 3rd party account
